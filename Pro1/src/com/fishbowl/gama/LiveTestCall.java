...
public class LiveTestCall {
	...
	public String MaUrl ="https://test.fishbowlcloud.com/#/";
	GAMAMeth obj=new GAMAMeth();
...
/*	@Test(priority=147)
	...
	@Test(priority=178)
	 public void smaDetailsFilerCheck()throws Exception{
		 ...
		 @Test(priority=179)
		 public void dshboardViewMA() throws Exception{
			 boolean a = obj.broadcastStartup();
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=180)
		 public void MaCampaignPageNavigation() throws Exception{
			 boolean a = obj.brodcastCampaignNaivation(MaUrl+"marketing/campaign");
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=181)
		 public void createBroadcastCampaign() throws Exception{
			 boolean a = obj.brodcastcampaignCreation();
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=182)
		 public void definingBroadcastCampaign() throws Exception{
			 boolean a = obj.boradcastDefineCmapaign();
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=183)
		 public void audienceBroadcastSelection() throws Exception{
			 boolean a = obj.broadcastAudienceCriteriaStore();
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=184)
		 public void storeBroadcastSelection() throws Exception{
			 boolean a = obj.broadcastStoreSlection();
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=185)
		 public void snedBroadcastNow() throws Exception{
			 boolean a = obj.broadcastSnedingSchedule();
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=186)
		 public void publishBroadcastMessage() throws Exception{
			 boolean a = obj.publishigBroadcast();
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=187)
		 public void acquisitionStart() throws Exception{
			 boolean a = obj.acquisitionStartUp();
			  Assert.assertEquals(a, true);
		 }
		
		 @Test(priority=188)
		 public void acqcampaignNaivation() throws Exception{
			 boolean a = obj.acqCampaignNaivation(MaUrl+"marketing/campaign");
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=189)
		 public void acqcampaignCreation() throws Exception{
			 boolean a = obj.acqCampaignCreation();
			  Assert.assertEquals(a, true);
		 }
		 @Test(priority=190)
		 public void acqdefineCmapaign() throws Exception{
			 boolean a = obj.acqDefineCmapaign();
			  Assert.assertEquals(a, true);
		 }
		 
		 @Test(priority=191)
		 public void acqsubscriptionCriteria() throws Exception{
			 boolean a = obj.acqSubscriptionCriteria();
			  Assert.assertEquals(a, true);
		 }

		 @Test(priority=192)
		 public void acqscheduling() throws Exception{
			 boolean a = obj.acqscheduling();
			  Assert.assertEquals(a, true);
		 }

		 @Test(priority=193)
		 public void acqpublishig() throws Exception{
			 boolean a = obj.acqpublishig();
			  Assert.assertEquals(a, true);
		 }
