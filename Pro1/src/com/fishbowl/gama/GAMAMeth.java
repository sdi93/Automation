...
import analyticsLive.ValidationMethod;
import malive.DBConnector;
import malive.ExcelFileRW;

public class GAMAMeth {
	...
	public String L1_storelist="//div[@class='checkBoxContainer']/child::*//*/span[@class='ng-binding']";
	...
	//SMSBroadcast variables
	List<String> list ;
	String broadcastCampaignName;
	String smstext ;
	String store;
	...
	public String dropd_smsType = "//select[@ng-change='smsCampaignTypeChange()']";//dialog to select type of SMS
	...
	//SMSAcquisition variables
	public List<String> listacq ;
	public String url;
	public String username;
	public String password;
	public String selectAll;
	public String starttime;
	public String acqCampaignname;
	public String CampaignDescription;
	public String Keyword ;
	public String welcomeMessage;
	public String PromotionID ;
	public String createcampaign;
	public String storeacq;
	public String extMemeber;
	public String invalidMessage;
	public String todayScheduling;
   ...
   public void hoverOnMainAndClickSubLink(WebElement mainElement, WebElement subElement)
   {
	...
	{		
		logger=report.startTest("SMS Broadcast");
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);
		try
		{
			ExcelFileRW read = new ExcelFileRW();
			list = read.readExcel(filePath, "ExportExcel.xlsx", "SMSBroadcast");
		 	broadcastCampaignName = list.get(4);
		 	smstext = list.get(6);
		 	store = list.get(7);
		 	driver.get(AppUrl);
		 	Random rand = new Random();
			int num = rand.nextInt(900) + 100;
			broadcastCampaignName = broadcastCampaignName+ String.valueOf(num);
			verifyelementL1(this.L1_L1, this.L1_L2, this.L1_L3, this.L1_L4, this.L1_L5, this.L1_L6, this.L1_L7, this.L1_L8);
	...
	public boolean brodcastCampaignNaivation(String maUrl)
	{		
			long start_m = System.currentTimeMillis();
			long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
			driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
	...
	public boolean brodcastcampaignCreation()
	{
		long start_m = System.currentTimeMillis();
		long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
		...
		try
		{
			...
			driver.findElement(By.xpath(textbox_campName)).sendKeys(broadcastCampaignName);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(textbox_campName)));
	...
	public boolean boradcastDefineCmapaign()
	{
		long start_m = System.currentTimeMillis();
		long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
	...
	public boolean broadcastAudienceCriteriaStore()
	{
		long start_m = System.currentTimeMillis();
		long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
		...
		try
		{
			...
			driver.findElement(By.xpath("//button[contains(.,'Save &')]")).click();//will be changed after prod refresh on may 22 2017
			logger.log(LogStatus.PASS, "Audience selection complete");
		}
		catch(Exception e)
		{
			logger.log(LogStatus.FAIL, "Audience selection complete");
			return false;
		}
		return true;
	}

	public boolean broadcastStoreSlection()
	{
		long start_m = System.currentTimeMillis();
		long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
	...
	public boolean broadcastSnedingSchedule()
	{
		long start_m = System.currentTimeMillis();
		long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
	...
	public boolean broadcastDatabaseTest()
	{	
		 String dbTable = null;
		...
		else if(reportName.equals("demo-live")){
			dbTable = "Jamba.Campaign";
			localhost = "10.80.40.20";
		}
		try
		{
			String query = "SELECT CampaignStatus FROM "+dbTable+" WHERE NAME ='"+broadcastCampaignName+"' LIMIT 1";
		
			for(int i=0;i<5;i++)
			{
				int reschk = DBConnector.dbCheck(localhost,"app_common","1@WSXCDE#4",query);
				if(reschk ==4){
	...
	public boolean acquisitionStartUp()
	{
		logger=report.startTest("SMS Acquisition");
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);
		...
		try
		{
			String filePath = "C:/Users/schaudhary_ic/Desktop";
			ExcelFileRW read = new ExcelFileRW();
			listacq = read.readExcel(filePath, "ExportExcel.xlsx", "Acquisition");
			selectAll = Keys.chord(Keys.CONTROL, "a");		
			acqCampaignname = listacq.get(4);
			CampaignDescription = listacq.get(5);
			Keyword = listacq.get(6);
			welcomeMessage = listacq.get(7);
			PromotionID = listacq.get(8);
			starttime = listacq.get(9);
			extMemeber = listacq.get(12);
			invalidMessage =listacq.get(13);
			confirmMessage = listacq.get(14);
			storeacq = listacq.get(15);
	 ...
	 public boolean acqCampaignNaivation(String url)
	 {
		long start_m = System.currentTimeMillis();
		long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
	 ...
	 public boolean acqCampaignCreation()
		{
			long start_m = System.currentTimeMillis();
			long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
			driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
			...
			try
			{
				...
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(textbox_campName)));
				driver.findElement(By.xpath(textbox_campName)).sendKeys(acqCampaignname);
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(textbox_campName)));
				driver.findElement(By.xpath(button_continue)).click();
	 ...
	 public boolean acqDefineCmapaign()
		{
			long start_m = System.currentTimeMillis();
			long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
			driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
	 ...
	 public boolean acqSubscriptionCriteria()
		{
			long start_m = System.currentTimeMillis();
			long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
			driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
			...
			try
			{
				...
				driver.findElement(By.xpath("//input[@value='Save & Next' and @class = 'bluebutton']")).click();
				logger.log(LogStatus.PASS, "Acquisition subscription criteria complete");				
			}
			catch(Exception e)
			{
				logger.log(LogStatus.FAIL, "Acquisition subscription criteria failed");
				return false;
			}
	 ...
	 public boolean acqscheduling()
		{
			...
			{			
				Thread.sleep(5000);
				driver.findElement(By.xpath("//input[@value='Save & Next' and @class = 'bluebutton']")).click();
				logger.log(LogStatus.PASS, "Sending schedule set for SMSAcquisition");
			}
			catch(Exception e)
			{
				System.out.println(e);
				logger.log(LogStatus.FAIL, "Setting sending schedule failed for SMSAcquisition");
				return false;
			}
			return true;
		}
	 
	 public boolean acqpublishig()
		{
		  	long start_m = System.currentTimeMillis();
			long start = TimeUnit.MILLISECONDS.toSeconds(start_m);
			driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);	
